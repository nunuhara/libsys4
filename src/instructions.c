...
//      TYPE   OPCODE          NR_ARGS, ARG_TYPES...
	OP   ( PUSH,           1, T_INT ),
        ...
        OP   ( SH_SASSIGN_STRUCTSREF, 1, T_MEMB ),
        OP   ( SH_SASSIGN_GLOBALSREF, 1, T_GLOBAL ),
        OP   ( SH_STRUCTSREF_NE_STR0, 2, T_MEMB, T_STRING ),
        OP   ( SH_GLOBALSREF_NE_STR0, 2, T_GLOBAL, T_STRING ),
        OP   ( SH_LOC_LT_IMM_OR_LOC_GE_IMM, 3, T_LOCAL, T_INT, T_INT ),
