...
struct flat_emitter {
	...
	float begin_scale;
	float begin_scale_rand;
	float end_scale;
	float end_scale_rand;
	float begin_x_scale;
	float begin_x_scale_rand;
	float end_x_scale;
	float end_x_scale_rand;
	float begin_y_scale;
	float begin_y_scale_rand;
	float end_y_scale;
	float end_y_scale_rand;
	bool sync_scale_rand;     // if true, begin/end use the same random offset
	int32_t direction_type;
	float direction_x;
	float direction_y;
	float direction_z;
	float direction_angle;
	int32_t parent_key_mode;
	int32_t pos_track_mode;
	int32_t uk_int3;
	int32_t inherit_alpha;
	int32_t inherit_rotation;
	int32_t inherit_scale;
	int32_t inherit_add_color;
	int32_t inherit_mul_color;
	int32_t inherit_draw_filter;
	int32_t inherit_reverse_lr;
	int32_t inherit_reverse_tb;
	float speed;
	float acceleration;
	float move_length;
	float move_curve;
	...
	bool align_to_direction; // if true, rotate particle to face movement direction
	float begin_x_angle;
	float begin_x_angle_rand;
	float end_x_angle;
	float end_x_angle_rand;
	float begin_y_angle;
	float begin_y_angle_rand;
	float end_y_angle;
	float end_y_angle_rand;
	float begin_z_angle;
	float begin_z_angle_rand;
	float end_z_angle;
	float end_z_angle_rand;
	bool sync_rotation_rand; // if true, begin/end use the same random offset
